...
const ProductEdit = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await fetch(`https://ecomercebackend-1.onrender.com/api/products/admin/getproducts/${id}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`https://ecomercebackend-1.onrender.com/api/products/admin/update/${id}`, {
        method: "PUT",
